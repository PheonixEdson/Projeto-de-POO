...
public class Clinica {
        ...
        do {
            ...
            switch (opcao) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    agendarConsulta(scanner, pacientes, medicos);
                    break;
                case 4:
    ...
    private static void cadastrarPaciente(Scanner scanner, List<Paciente> pacientes) {
        ...
        Paciente paciente = new Paciente(nome, idade, email, telefone);
    ...
    private static void agendarConsulta(Scanner scanner, List<Paciente> pacientes, List<Medico> medicos) {
        listarPacientes(pacientes);
